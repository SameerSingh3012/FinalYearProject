...
mongoose.connect("mongodb://127.0.0.1/ProjectPortal", { useNewUrlParser: true,useUnifiedTopology: true,useFindAndModify:false}).
then(()=>{
...
app.get("/userprofile",middleware.isLoggedIn,function(req,res){
  Appliedproject.find({}).deleteOne().exec();
